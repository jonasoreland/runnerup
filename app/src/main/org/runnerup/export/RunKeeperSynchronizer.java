...
public class RunKeeperSynchronizer extends DefaultSynchronizer
    implements Synchronizer, OAuth2Server {
  ...
  static {
    // sports list can be found at
    // http://developer.runkeeper.com/healthgraph/fitness-activities#past
    /*
