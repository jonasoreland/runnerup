...
public class TrackerGPS extends DefaultTrackerComponent implements TickListener {
  ...
  public void setWithoutGps(boolean val) {
    System.out.println("KESO: setWithoutGps("+val+"), mWithoutGps: " + mWithoutGps + " getState(): " + tracker.getState());
    if (mWithoutGps == val) {
      return;
    }
    mWithoutGps = val;
  ...
  public ResultCode onConnecting(final Callback callback, Context context) {
    System.out.println("KESO: TrackerGPS.onConnecting: mWithoutGps: " + mWithoutGps);
