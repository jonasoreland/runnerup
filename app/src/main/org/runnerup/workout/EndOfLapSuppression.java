...
/**
 * This suppression is for suppressing interval (distance) triggers really close too end of lap
 * (currently 5 meters)
 *
 * @author jonas
 */
public class EndOfLapSuppression extends TriggerSuppression {
  ...
  public static final TriggerSuppression EmptyLapSuppression =
      new EndOfLapSuppression(t_type.t_Empty);
  public static final TriggerSuppression EndOfLapSuppression =
      new EndOfLapSuppression(t_type.t_EndOfLap);
