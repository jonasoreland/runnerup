...
public abstract class Feedback {
  ...
  /**
   * compare feedback to another feedback so that same information isn't emitted twice (or more)
   * during one tick i.e different triggers can have same feedback
   *
   * @param other
   */
