...
interface WorkoutComponent {
  ...
  /** Called at least once before onStart Can be called later if orientation changes */
  ...
  /** Called when user press PauseButton after this either onResume or onComplete will be called */
  void onPause(Workout s);

  /** Called when user press StopButton after this either onResume or onComplete will be called */
