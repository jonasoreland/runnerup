...
public enum Sport {
    ...
    RUNNING(DB.ACTIVITY.SPORT_RUNNING, R.string.txt_sport_Running),
    BIKING(DB.ACTIVITY.SPORT_BIKING, R.string.txt_sport_Biking),
    OTHER(DB.ACTIVITY.SPORT_OTHER, R.string.txt_sport_Other);
