...
/**
 * This interface is used instead as a device handle. (since Ant+ doesn't used BluetoothDevice as a
...
public class HRDeviceRef {
  ...
  public String getName() {
    if (deviceName != null && !"".contentEquals(deviceName)) return deviceName;
