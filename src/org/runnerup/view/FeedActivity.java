	...
	class FeedListAdapter extends BaseAdapter implements Observer {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if (FeedList.isHeaderDate(tmp)) {
				...
				String name = formatter.formatName(tmp.getAsString(DB.FEED.USER_FIRST_NAME), tmp.getAsString(DB.FEED.USER_LAST_NAME));
...
//				c.put(FEED.FEED_SUBTYPE, getTrainingType(o.getInt("TrainingTypeID"), o.getString("TrainingTypeName")));
//				c.put(FEED.FEED_TYPE_STRING, o.getString("TrainingTypeName"));
...
//								+ Long.toString(o.getLong("ID")));
    ...
    Map<String, Drawable> imageCache = Collections.synchronizedMap(new WeakHashMap<String, Drawable>());
