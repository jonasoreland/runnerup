...
public class WorkoutSerializer {
	...
	private static Pair<Dimension, Double> NullDimensionPair = new Pair<Dimension, Double>(null, 0.0);
	private static Pair<Dimension, Double> getDuration(JSONObject obj, Intensity intensity) throws JSONException {
		Dimension dim = null;
		double val = 0;
